...
trainNPath = "images/chest_xray/train/NORMAL/"  # specify your path here
...
trainPPath = "images/chest_xray/train/PNEUMONIA/"  # specify your path here
...
## using truncated dataset: {'C': 100, 'gamma': 'scale', 'kernel': 'rbf'}
...
## run with best params from CV? actually just use 'rbf':
...
testNPath = "images/chest_xray/test/NORMAL/"  # specify your path here
testNRaw, testNLabel = readImageDir(testNPath, 0)
testNResized = resizeSquare(testNRaw, resizedDim)
del testNRaw
testPPath = "images/chest_xray/test/PNEUMONIA/"  # specify your path here
